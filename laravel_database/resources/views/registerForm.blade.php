 		...
 		<table class="table ">
			 ...
			 @foreach($users as $user)
 				<tr class="table-light">
 					...
 					<td>{{$user->email}}</td>
 					<td>{{$user->mobile}}</td>
					 <td><a href='/destroy/{{$user->userid}}' type="button" style="color:#fff"class="btn btn-danger ">Delete</a></td>
					 <td><a href='/edit/{{$user->userid}}'type="button" style="color:#fff"class="btn btn-warning">Edit</a></td>
